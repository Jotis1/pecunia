/** biome-ignore-all lint/suspicious/noExplicitAny: We cannot use type `unknown` instead of `any` here because it will break the type assertion `isReactComponent` function is providing. */
